...
# Dynamically find the project root and add `src` to the Python path
...
def load_inference_modules():
    ...
    return load_predictions_from_store, load_batch_of_features_from_store
...
def load_feature_store_api():
    from src.feature_store_api import create_feature_group_if_not_exists
    return create_feature_group_if_not_exists

load_predictions_from_store, load_batch_of_features_from_store = load_inference_modules()
DATA_DIR = load_paths_module()
plot_one_sample = load_plot_module()
create_feature_group_if_not_exists = load_feature_store_api()

# Ensure the feature group exists
create_feature_group_if_not_exists()
...
# Debug print to check the contents of predictions_df
...
# Debug print to check the status of predictions availability
st.write("Next hour predictions ready:", next_hour_predictions_ready)
st.write("Previous hour predictions ready:", prev_hour_predictions_ready)
